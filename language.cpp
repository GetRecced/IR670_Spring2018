...
void topicCorpus::dl(double *grad) {
    ...
    getG(grad, &(dalpha), &(dkappa), &(dbeta_user), &(dbeta_beer), &(dgamma_user), &(dgamma_beer), &(dtopicWords),
         true);
...
bool sortBySecondDescending(const pair<string,double> &a,
                   const pair<string,double> &b)
{
    return a.second>b.second;
}

vector<string> topicCorpus::getRecommendationsForUser(string userId)
{
